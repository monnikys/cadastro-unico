...
export const participantes: Participante[] = [
  ...
  {
    cpf: "835.030.564-18",
    nome: "Igor Fagundes Zanetti",
    planos: [{ sigla: "PGA", inscricao: "21/04/2005", situacao: "Assistido" }],
    uf: "CE",
    idade: 68,
    sexo: "M",
    email: "igor.zanetti@exemplo.com.br",
    telefone: "(85) 97482-8517",
  },
  {
    cpf: "696.532.871-16",
  ...
  },
  {
    ...
    planos: [{ sigla: "PGA", inscricao: "16/11/1993", situacao: "Ativo" }, { sigla: "PBDC", inscricao: "28/09/2001", situacao: "Assistido" }],
    uf: "DF",
    idade: 35,
    sexo: "M",
  ...
  {
    cpf: "736.026.064-68",
    nome: "Mauricio Pereira Kowalski",
    planos: [{ sigla: "PGA", inscricao: "07/03/2016", situacao: "Assistido" }],
    uf: "AM",
    idade: 59,
    sexo: "M",
    email: "mauricio.kowalski@exemplo.com.br",
    telefone: "(92) 94566-1958",
  },
  {
    cpf: "788.208.121-86",
  ...
  {
    cpf: "353.462.475-19",
    nome: "Beatriz Neves Medeiros",
    planos: [{ sigla: "PGA", inscricao: "03/02/2021", situacao: "Ativo" }],
    uf: "ES",
    idade: 44,
    sexo: "F",
    email: "beatriz.medeiros@exemplo.com.br",
    telefone: "(27) 99288-5345",
  },
  {
    cpf: "427.849.808-48",
  ...
  {
    cpf: "640.052.427-80",
    nome: "Regina Holanda Quintana",
    planos: [{ sigla: "PGA", inscricao: "03/02/1985", situacao: "Ativo" }],
    uf: "SP",
    idade: 33,
    sexo: "F",
    email: "regina.quintana@exemplo.com.br",
    telefone: "(11) 99938-1590",
  },
  {
    cpf: "045.053.315-81",
  ...
  {
    cpf: "957.773.872-94",
    nome: "Nelson Santana Novaes",
    planos: [{ sigla: "PGA", inscricao: "27/02/2006", situacao: "Ativo" }],
    uf: "AM",
    idade: 65,
    sexo: "M",
    email: "nelson.novaes@exemplo.com.br",
    telefone: "(92) 96085-4680",
  },
  {
    cpf: "917.693.676-41",
...
export const dependentes: Dependente[] = [
  ...
  {
    nome: "Isabela Holanda Quintana",
    cpf: "170.805.310-13",
    titular: "Regina Holanda Quintana",
    cpfTitular: "640.052.427-80",
    parentesco: "Enteado(a)",
    idade: 5,
    plano: "PGA",
  },
  ...
  {
    nome: "Flavia Henriques Medeiros",
    cpf: "058.651.850-63",
    titular: "Igor Fagundes Zanetti",
    cpfTitular: "835.030.564-18",
    parentesco: "Cônjuge",
    idade: 63,
    plano: "PGA",
  },
  ...
  {
    nome: "Fernanda Neves Medeiros",
    cpf: "735.454.948-11",
    titular: "Beatriz Neves Medeiros",
    cpfTitular: "353.462.475-19",
    parentesco: "Filho(a)",
    idade: 16,
    plano: "PGA",
  },
  ...
  {
    nome: "Julio Pereira Kowalski",
    cpf: "343.524.082-45",
    titular: "Mauricio Pereira Kowalski",
    cpfTitular: "736.026.064-68",
    parentesco: "Filho(a)",
    idade: 19,
    plano: "PGA",
  },
